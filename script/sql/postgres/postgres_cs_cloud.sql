...
(
    ...
    tenant_type       varchar(32)   default 'platform_operation'::varchar,
...
insert into sys_tenant values(1, '000000', '管理组', '15888888888', 'platform_operation', 'XXX有限公司', null, null, '多租户通用后台管理管理系统', null, null, null, null, -1, '0', '0', 103, 1, now(), null, null);
...
insert into sys_menu values('4', 'PLUS官网', '0', '5', 'https://gitee.com/dromara/csmp', null, '', '0', '0', 'M', '0', '0', '', 'guide',    103, 1, now(), null, null, 'csmp官网地址');
...
insert into sys_menu values('103',  '部门管理',     '1',   '5', 'dept',             'system/dept/index',            '', '1', '0', 'C', '0', '0', 'system:dept:list',            'tree',          103, 1, now(), null, null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理',     '1',   '6', 'post',             'system/post/index',            '', '1', '0', 'C', '0', '0', 'system:post:list',            'post',          103, 1, now(), null, null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理',     '1',   '7', 'dict',             'system/dict/index',            '', '1', '0', 'C', '0', '0', 'system:dict:list',            'dict',          103, 1, now(), null, null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置',     '1',   '8', 'config',           'system/config/index',          '', '1', '0', 'C', '0', '0', 'system:config:list',          'edit',          103, 1, now(), null, null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告',     '1',   '9', 'notice',           'system/notice/index',          '', '1', '0', 'C', '0', '0', 'system:notice:list',          'message',       103, 1, now(), null, null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理',     '1',   '10', 'log',             '',                             '', '1', '0', 'M', '0', '0', '',                            'log',           103, 1, now(), null, null, '日志管理菜单');
...
insert into sys_menu values('123',  '客户端管理',   '1',   '12', 'client',           'system/client/index',          '', '1', '0', 'C', '0', '0', 'system:client:list',          'international', 103, 1, now(), null, null, '客户端管理菜单');
...
-- oss菜单
insert into sys_menu values('118',  '文件管理',     '1',   '11', 'oss',              'system/oss/index',            '', '1', '0', 'C', '0', '0', 'system:oss:list',             'upload',        103, 1, now(), null, null, '文件管理菜单');
-- 三级菜单
...
INSERT INTO sys_dict_type VALUES (16, '000000', '租户类型', 'sys_tenant_type', 103, 1, now(), NULL, NULL, '租户类型列表');
...
INSERT INTO sys_dict_data VALUES (55, '000000', 1, '平台运营', 'platform_operation', 'sys_tenant_type', '', 'primary', 'Y', 103, 1, now(), NULL, NULL, '平台运营');
INSERT INTO sys_dict_data VALUES (56, '000000', 2, '平台监管', 'platform_regulation', 'sys_tenant_type', '', 'warning', 'N', 103, 1, now(), NULL, NULL, '平台监管');
INSERT INTO sys_dict_data VALUES (57, '000000', 3, '云租户', 'cloud_tenant', 'sys_tenant_type', '', 'success', 'N', 103, 1, now(), NULL, NULL, '云租户');
INSERT INTO sys_dict_data VALUES (58, '000000', 4, '代维服务商', 'service_provider', 'sys_tenant_type', '', 'info', 'N', 103, 1, now(), NULL, NULL, '代维服务商');
...
insert into sys_oss_config values (1, '000000', 'minio',  'csmp',            'csmp123',        'csmp',             '', '127.0.0.1:9000',                      '','N', '',            '1', '0', '', 103, 1, now(), 1, now(), null);
insert into sys_oss_config values (2, '000000', 'qiniu',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp',             '', 's3-cn-north-1.qiniucs.com',           '','N', '',            '1', '1', '', 103, 1, now(), 1, now(), null);
insert into sys_oss_config values (3, '000000', 'aliyun', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp',             '', 'oss-cn-beijing.aliyuncs.com',         '','N', '',            '1', '1', '', 103, 1, now(), 1, now(), null);
insert into sys_oss_config values (4, '000000', 'qcloud', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp-1240000000',  '', 'cos.ap-beijing.myqcloud.com',         '','N', 'ap-beijing',  '1', '1', '', 103, 1, now(), 1, now(), null);
insert into sys_oss_config values (5, '000000', 'image',  'csmp',            'csmp123',        'csmp',             'image', '127.0.0.1:9000',                 '','N', '',            '1', '1', '', 103, 1, now(), 1, now(), NULL);
