...
insert into sys_role values('3', '000000', '本部门及以下', 'test1', 3, 4, 1, 1, null, 0, '0', '0', 103, 1, sysdate, null, null, null);
insert into sys_role values('4', '000000', '仅本人',      'test2', 4, 5, 1, 1, null, 0, '0', '0', 103, 1, sysdate, null, null, null);
...
insert into sys_menu values('4', 'PLUS官网', '0', '5', 'https://gitee.com/dromara/csmp', null, '', 0, 0, 'M', '0', '0', '', 'guide',    103, 1, sysdate, null, null, 'csmp官网地址');
...
insert into sys_menu values('2000', '组织机构',     '1',   '4', 'org',              'system/org/index',             '', 1, 0, 'C', '0', '0', 'system:org:list',             'tree',          103, 1, sysdate, null, null, '组织机构管理菜单');
insert into sys_menu values('103',  '部门管理',     '1',   '5', 'dept',             'system/dept/index',            '', 1, 0, 'C', '0', '0', 'system:dept:list',            'tree',          103, 1, sysdate, null, null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理',     '1',   '6', 'post',             'system/post/index',            '', 1, 0, 'C', '0', '0', 'system:post:list',            'post',          103, 1, sysdate, null, null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理',     '1',   '7', 'dict',             'system/dict/index',            '', 1, 0, 'C', '0', '0', 'system:dict:list',            'dict',          103, 1, sysdate, null, null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置',     '1',   '8', 'config',           'system/config/index',          '', 1, 0, 'C', '0', '0', 'system:config:list',          'edit',          103, 1, sysdate, null, null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告',     '1',   '9', 'notice',           'system/notice/index',          '', 1, 0, 'C', '0', '0', 'system:notice:list',          'message',       103, 1, sysdate, null, null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理',     '1',   '10', 'log',             '',                             '', 1, 0, 'M', '0', '0', '',                            'log',           103, 1, sysdate, null, null, '日志管理菜单');
...
insert into sys_menu values('123',  '客户端管理',   '1',   '12', 'client',          'system/client/index',          '', 1, 0, 'C', '0', '0', 'system:client:list',          'international', 103, 1, sysdate, null, null, '客户端管理菜单');
...
-- oss菜单
insert into sys_menu values('118',  '文件管理',     '1',    '11', 'oss',             'system/oss/index',            '', 1, 0, 'C', '0', '0', 'system:oss:list',             'upload',        103, 1, sysdate, null, null, '文件管理菜单');
-- 三级菜单
...
alter table sys_role_hidden_menu add constraint pk_sys_role_hidden_menu primary key (role_id, menu_id);
...
create table sys_role_effective_menu (
  ...
  inherit_from_role_id number(20)    default null
);

alter table sys_role_effective_menu add constraint pk_sys_role_effective_menu primary key (role_id, menu_id);
...
-- 初始化-角色有效菜单物化表数据
-- ----------------------------
insert /*+ ignore_row_on_dupkey_index(sys_role_effective_menu, pk_sys_role_effective_menu) */
into sys_role_effective_menu (role_id, menu_id, source, inherit_from_role_id)
...
insert into sys_oss_config values (1, '000000', 'minio',  'csmp',            'csmp123',        'csmp',             '', '127.0.0.1:9000',                '','N', '',            '1', '0', '', NULL, 103, 1, sysdate, 1, sysdate);
insert into sys_oss_config values (2, '000000', 'qiniu',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp',             '', 's3-cn-north-1.qiniucs.com',     '','N', '',            '1', '1', '', NULL, 103, 1, sysdate, 1, sysdate);
insert into sys_oss_config values (3, '000000', 'aliyun', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp',             '', 'oss-cn-beijing.aliyuncs.com',   '','N', '',            '1', '1', '', NULL, 103, 1, sysdate, 1, sysdate);
insert into sys_oss_config values (4, '000000', 'qcloud', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'csmp-1250000000',  '', 'cos.ap-beijing.myqcloud.com',   '','N', 'ap-beijing',  '1', '1', '', NULL, 103, 1, sysdate, 1, sysdate);
insert into sys_oss_config values (5, '000000', 'image',  'csmp',            'csmp123',        'csmp',             'image', '127.0.0.1:9000',           '','N', '',            '1', '1', '', NULL, 103, 1, sysdate, 1, sysdate);
